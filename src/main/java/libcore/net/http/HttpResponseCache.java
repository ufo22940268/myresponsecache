...
public final class HttpResponseCache extends ResponseCache implements ExtendedResponseCache {
    ...
    public String getContentEncoding(URI uri) {
        String key = uriToKey(uri);
//        System.out.println("header key = " + key);
        ...
        if (entry != null) {
            RawHeaders responseHeaders = entry.responseHeaders;
            return responseHeaders.get("Content-Encoding");
        } else {
            return "";
        }
    }
    ...
    public void update(CacheResponse conditionalCacheHit, HttpURLConnection httpConnection) {
        ...
        Entry entry = new Entry(uri, varyHeaders, httpConnection, getContentEncoding(uri));
    ...
    private static final class Entry {
        ...
        public Entry(URI uri, RawHeaders varyHeaders, HttpURLConnection httpConnection, String ec) {
            this.uri = uri.toString();
            this.varyHeaders = varyHeaders;
            this.requestMethod = httpConnection.getRequestMethod();
            this.responseHeaders = RawHeaders.fromMultimap(httpConnection.getHeaderFields());
            this.responseHeaders.set("Content-Encoding", ec);
